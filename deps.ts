...
export { goldsmithMarkdown } from "https://deno.land/x/goldsmith@1.2.1/plugins/markdown/mod.ts";
...
export { goldsmithWatch } from "https://deno.land/x/goldsmith@1.2.1/plugins/watch/mod.ts";
