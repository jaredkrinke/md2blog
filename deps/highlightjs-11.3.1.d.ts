...
export type HLJSPlugin = {
    ...
    'after:highlightElement'?: (data: { el: any, result: HighlightResult, text: string}) => void,
    'before:highlightElement'?: (data: { el: any, language: string}) => void,
    // TODO: Old API, remove with v12
    'after:highlightBlock'?: (data: { block: any, result: HighlightResult, text: string}) => void,
    'before:highlightBlock'?: (data: { block: any, language: string}) => void,
}
...
export type HighlightedHTMLElement = any & {result?: object, secondBest?: object, parentNode: any}
...
declare const HighlightJS: HLJSApi;
